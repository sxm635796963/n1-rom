...
# Add crontab
echo '*/1 * * * * /usr/bin/mwan3-watchdog' >> /etc/crontabs/root
...
svn co https://github.com/cocokfeng/luci-theme-argon/trunk luci/themes/luci-theme-argon
svn co https://github.com/cocokfeng/luci-app-argon-config/trunk package/luci-app-argon-config
svn co https://github.com/cocokfeng/luci-theme-argon/trunk package/lean/luci-argon
...
rm -rf luci/themes/luci-theme-argon/htdocs/luci-static/argon/img/bg1.jpg
cp -f package/lean/luci-argon/htdocs/luci-static/argon/img/bg1.jpg luci/themes/luci-theme-argon/htdocs/luci-static/argon/img/bg1.jpg
